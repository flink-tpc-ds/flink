...
object CatalogSales extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    ...
    Column("cs_item_sk", 15, DataTypes.BIGINT, false, true),
    Column("cs_promo_sk", 16, DataTypes.BIGINT),
    Column("cs_order_number", 17, DataTypes.BIGINT, false, true),
...
object CatalogReturns extends TpcDsSchema {
  override val columns = Array[Column](
    ...
    Column("cr_item_sk", 2, DataTypes.BIGINT, false, true),
    ...
    Column("cr_order_number", 16, DataTypes.BIGINT, false, true),
...
object Inventory extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("inv_date_sk", 0, DataTypes.BIGINT, false, true),
    Column("inv_item_sk", 1, DataTypes.BIGINT, false, true),
    Column("inv_warehouse_sk", 2, DataTypes.BIGINT, false, true),
...
object StoreSales extends TpcDsSchema {
  override val columns = Array[Column](
    Column("ss_sold_date_sk", 0, DataTypes.BIGINT, true, false),
    Column("ss_sold_time_sk", 1, DataTypes.BIGINT, true, false),
    Column("ss_item_sk", 2, DataTypes.BIGINT, false, true),
    Column("ss_customer_sk", 3, DataTypes.BIGINT, true, false),
    Column("ss_cdemo_sk", 4, DataTypes.BIGINT, true, false),
    Column("ss_hdemo_sk", 5, DataTypes.BIGINT, true, false),
    Column("ss_addr_sk", 6, DataTypes.BIGINT, true, false),
    Column("ss_store_sk", 7, DataTypes.BIGINT, true, false),
    Column("ss_promo_sk", 8, DataTypes.BIGINT, true, false),
    Column("ss_ticket_number", 9, DataTypes.BIGINT, false, true),
    Column("ss_quantity", 10, DataTypes.BIGINT, true, false),
    Column("ss_wholesale_cost", 11, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_list_price", 12, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_sales_price", 13, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_ext_discount_amt", 14, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_ext_sales_price", 15, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_ext_wholesale_cost", 16, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_ext_list_price", 17, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_ext_tax", 18, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_coupon_amt", 19, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_net_paid", 20, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_net_paid_inc_tax", 21, DataTypes.DECIMAL(7, 2), true, false),
    Column("ss_net_profit", 22, DataTypes.DECIMAL(7, 2), true, false)
  )
}
...
object StoreReturns extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("sr_returned_date_sk", 0, DataTypes.BIGINT, true, false),
    Column("sr_return_time_sk", 1, DataTypes.BIGINT, true, false),
    Column("sr_item_sk", 2, DataTypes.BIGINT, false, true),
    Column("sr_customer_sk", 3, DataTypes.BIGINT, true, false),
    Column("sr_cdemo_sk", 4, DataTypes.BIGINT, true, false),
    Column("sr_hdemo_sk", 5, DataTypes.BIGINT, true, false),
    Column("sr_addr_sk", 6, DataTypes.BIGINT, true, false),
    Column("sr_store_sk", 7, DataTypes.BIGINT, true, false),
    Column("sr_reason_sk", 8, DataTypes.BIGINT, true, false),
    Column("sr_ticket_number", 9, DataTypes.BIGINT, false, true),
    Column("sr_return_quantity", 10, DataTypes.BIGINT, true, false),
    Column("sr_return_amt", 11, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_return_tax", 12, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_return_amt_inc_tax", 13, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_fee", 14, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_return_ship_cost", 15, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_refunded_cash", 16, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_reversed_charge", 17, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_store_credit", 18, DataTypes.DECIMAL(7, 2), true, false),
    Column("sr_net_loss", 19, DataTypes.DECIMAL(7, 2), true, false)
  )
...
object WebSales extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("ws_sold_date_sk", 0, DataTypes.BIGINT, true, false),
    Column("ws_sold_time_sk", 1, DataTypes.BIGINT, true, false),
    Column("ws_ship_date_sk", 2, DataTypes.BIGINT, true, false),
    Column("ws_item_sk", 3, DataTypes.BIGINT, false, true),
    Column("ws_bill_customer_sk", 4, DataTypes.BIGINT, true, false),
    Column("ws_bill_cdemo_sk", 5, DataTypes.BIGINT, true, false),
    Column("ws_bill_hdemo_sk", 6, DataTypes.BIGINT, true, false),
    Column("ws_bill_addr_sk", 7, DataTypes.BIGINT, true, false),
    Column("ws_ship_customer_sk", 8, DataTypes.BIGINT, true, false),
    Column("ws_ship_cdemo_sk", 9, DataTypes.BIGINT, true, false),
    Column("ws_ship_hdemo_sk", 10, DataTypes.BIGINT, true, false),
    Column("ws_ship_addr_sk", 11, DataTypes.BIGINT, true, false),
    Column("ws_web_page_sk", 12, DataTypes.BIGINT, true, false),
    Column("ws_web_site_sk", 13, DataTypes.BIGINT, true, false),
    Column("ws_ship_mode_sk", 14, DataTypes.BIGINT, true, false),
    Column("ws_warehouse_sk", 15, DataTypes.BIGINT, true, false),
    Column("ws_promo_sk", 16, DataTypes.BIGINT, true, false),
    Column("ws_order_number", 17, DataTypes.BIGINT, false, true),
    Column("ws_quantity", 18, DataTypes.BIGINT, true, false),
    Column("ws_wholesale_cost", 19, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_list_price", 20, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_sales_price", 21, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_ext_discount_amt", 22, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_ext_sales_price", 23, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_ext_wholesale_cost", 24, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_ext_list_price", 25, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_ext_tax", 26, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_coupon_amt", 27, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_ext_ship_cost", 28, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_net_paid", 29, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_net_paid_inc_tax", 30, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_net_paid_inc_ship", 31, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_net_paid_inc_ship_tax", 32, DataTypes.DECIMAL(7, 2), true, false),
    Column("ws_net_profit", 33, DataTypes.DECIMAL(7, 2), true, false)
  )
}
...
object WebReturns extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("wr_returned_date_sk", 0, DataTypes.BIGINT, true, false),
    Column("wr_returned_time_sk", 1, DataTypes.BIGINT, true, false),
    Column("wr_item_sk", 2, DataTypes.BIGINT, false, true),
    Column("wr_refunded_customer_sk", 3, DataTypes.BIGINT, true, false),
    Column("wr_refunded_cdemo_sk", 4, DataTypes.BIGINT, true, false),
    Column("wr_refunded_hdemo_sk", 5, DataTypes.BIGINT, true, false),
    Column("wr_refunded_addr_sk", 6, DataTypes.BIGINT, true, false),
    Column("wr_returning_customer_sk", 7, DataTypes.BIGINT, true, false),
    Column("wr_returning_cdemo_sk", 8, DataTypes.BIGINT, true, false),
    Column("wr_returning_hdemo_sk", 9, DataTypes.BIGINT, true, false),
    Column("wr_returning_addr_sk", 10, DataTypes.BIGINT, true, false),
    Column("wr_web_page_sk", 11, DataTypes.BIGINT, true, false),
    Column("wr_reason_sk", 12, DataTypes.BIGINT, true, false),
    Column("wr_order_number", 13, DataTypes.BIGINT, false, true),
    Column("wr_return_quantity", 14, DataTypes.BIGINT, true, false),
    Column("wr_return_amt", 15, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_return_tax", 16, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_return_amt_inc_tax", 17, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_fee", 18, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_return_ship_cost", 19, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_refunded_cash", 20, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_reversed_charge", 21, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_account_credit", 22, DataTypes.DECIMAL(7, 2), true, false),
    Column("wr_net_loss", 23, DataTypes.DECIMAL(7, 2), true, false)
  )
}
...
object CallCenter extends TpcDsSchema {
  override val columns = Array[Column](
    ...
    Column("cc_employees", 8, DataTypes.BIGINT, true, false),
    Column("cc_sq_ft", 9, DataTypes.BIGINT, true, false),
    Column("cc_hours", 10, DataTypes.STRING, true, false),
    Column("cc_manager", 11, DataTypes.STRING, true, false),
    Column("cc_mkt_id", 12, DataTypes.BIGINT, true, false),
    ...
    Column("cc_division", 16, DataTypes.BIGINT, true, false),
    Column("cc_division_name", 17, DataTypes.STRING, true, false),
    Column("cc_company", 18, DataTypes.BIGINT, true, false),
    ...
    Column("cc_gmt_offset", 29, DataTypes.DECIMAL(5, 2), true, false),
    Column("cc_tax_percentage", 30, DataTypes.DECIMAL(5, 2), true, false)
  )
}
...
object CatalogPage extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("cp_catalog_page_sk", 0, DataTypes.BIGINT, false, true),
    Column("cp_catalog_page_id", 1, DataTypes.STRING, false, false),
    Column("cp_start_date_sk", 2, DataTypes.BIGINT, true, false),
    Column("cp_end_date_sk", 3, DataTypes.BIGINT, true, false),
    Column("cp_department", 4, DataTypes.STRING, true, false),
    Column("cp_catalog_number", 5, DataTypes.BIGINT, true, false),
    Column("cp_catalog_page_number", 6, DataTypes.BIGINT, true, false),
...
object CustomerDS extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("c_customer_sk", 0, DataTypes.BIGINT, false, true),
    Column("c_customer_id", 1, DataTypes.STRING, false, false),
    Column("c_current_cdemo_sk", 2, DataTypes.BIGINT, true, false),
    Column("c_current_hdemo_sk", 3, DataTypes.BIGINT, true, false),
    Column("c_current_addr_sk", 4, DataTypes.BIGINT, true, false),
    Column("c_first_shipto_date_sk", 5, DataTypes.BIGINT, true, false),
    Column("c_first_sales_date_sk", 6, DataTypes.BIGINT, true, false),
    ...
    Column("c_birth_day", 11, DataTypes.BIGINT, true, false),
    Column("c_birth_month", 12, DataTypes.BIGINT, true, false),
    Column("c_birth_year", 13, DataTypes.BIGINT, true, false),
    ...
    Column("c_last_review_date", 17, DataTypes.BIGINT, true, false)
  )
...
object CustomerAddress extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("ca_address_sk", 0,  DataTypes.BIGINT, false, true),
    ...
    Column("ca_gmt_offset", 11, DataTypes.DECIMAL(5, 2), true, false),
...
object CustomerDemographics extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("cd_demo_sk", 0, DataTypes.BIGINT, false, true),
    ...
    Column("cd_purchase_estimate", 4, DataTypes.BIGINT, true, false),
    Column("cd_credit_rating", 5, DataTypes.STRING, true, false),
    Column("cd_dep_count", 6, DataTypes.BIGINT, true, false),
    Column("cd_dep_employed_count", 7, DataTypes.BIGINT, true, false),
    Column("cd_dep_college_count", 8, DataTypes.BIGINT, true, false)
  )
...
object DateDim extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    ...
    Column("d_year", 6, DataTypes.BIGINT, true, false),
    Column("d_dow", 7, DataTypes.BIGINT, true, false),
    Column("d_moy", 8, DataTypes.BIGINT, true, false),
    Column("d_dom", 9, DataTypes.BIGINT, true, false),
    Column("d_qoy", 10, DataTypes.BIGINT, true, false),
    Column("d_fy_year", 11, DataTypes.BIGINT, true, false),
    Column("d_fy_quarter_seq", 12, DataTypes.BIGINT, true, false),
    Column("d_fy_week_seq", 13, DataTypes.BIGINT, true, false),
    ...
    Column("d_first_dom", 19, DataTypes.BIGINT, true, false),
    Column("d_last_dom", 20, DataTypes.BIGINT, true, false),
    Column("d_same_day_ly", 21, DataTypes.BIGINT, true, false),
    Column("d_same_day_lq", 22, DataTypes.BIGINT, true, false),
...
object HouseholdDemographics extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("hd_demo_sk", 0, DataTypes.BIGINT, false, true),
    Column("hd_income_band_sk", 1, DataTypes.BIGINT, true, false),
    Column("hd_buy_potential", 2,  DataTypes.STRING, true, false),
    Column("hd_dep_count", 3, DataTypes.BIGINT, true, false),
    Column("hd_vehicle_count", 4, DataTypes.BIGINT, true, false)
  )
}
...
object IncomeBand extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("ib_income_band_sk", 0, DataTypes.BIGINT, false, true),
    Column("ib_lower_bound", 1, DataTypes.BIGINT, true, false),
    Column("ib_upper_bound", 2, DataTypes.BIGINT, true, false)
  )
...
object Item extends TpcDsSchema {
  override val columns = Array[Column](
    ...
    Column("i_brand_id", 7, DataTypes.BIGINT, true, false),
    Column("i_brand", 8, DataTypes.STRING, true, false),
    Column("i_class_id", 9, DataTypes.BIGINT, true, false),
    Column("i_class", 10, DataTypes.STRING, true, false),
    Column("i_category_id", 11, DataTypes.BIGINT, true, false),
    Column("i_category", 12, DataTypes.STRING, true, false),
    Column("i_manufact_id", 13, DataTypes.BIGINT, true, false),
    ...
    Column("i_manager_id", 20, DataTypes.BIGINT, true, false),
...
object Promotion extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("p_promo_sk", 0, DataTypes.BIGINT, false, true),
    Column("p_promo_id", 1, DataTypes.STRING, false, false),
    Column("p_start_date_sk", 2, DataTypes.BIGINT, true, false),
    Column("p_end_date_sk", 3, DataTypes.BIGINT, true, false),
    Column("p_item_sk", 4, DataTypes.BIGINT, true, false),
    Column("p_cost", 5, DataTypes.DECIMAL(15, 2), true, false),
    Column("p_response_target", 6, DataTypes.BIGINT, true, false),
...
object Reason extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("r_reason_sk", 0, DataTypes.BIGINT, false, true),
...
object ShipMode extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("sm_ship_mode_sk", 0,  DataTypes.BIGINT, false, true),
...
object Store extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    ...
    Column("s_floor_space", 7, DataTypes.BIGINT, true, false),
    Column("s_hours", 8, DataTypes.STRING, true, false),
    Column("s_manager", 9, DataTypes.STRING, true, false),
    Column("s_market_id", 10,  DataTypes.BIGINT, true, false),
    ...
    Column("s_division_id", 14, DataTypes.BIGINT, true, false),
    Column("s_division_name", 15, DataTypes.STRING, true, false),
    Column("s_company_id", 16, DataTypes.BIGINT, true, false),
    ...
    Column("s_gmt_offset", 27, DataTypes.DECIMAL(5, 2), true, false),
    Column("s_tax_precentage", 28, DataTypes.DECIMAL(5, 2), true, false)
  )
...
object TimeDim extends TpcDsSchema {
  override val columns = Array[Column](
    Column("t_time_sk", 0, DataTypes.BIGINT, false, true),
    Column("t_time_id", 1, DataTypes.STRING, false, false),
    Column("t_time", 2, DataTypes.BIGINT, true, false),
    Column("t_hour", 3, DataTypes.BIGINT, true, false),
    Column("t_minute", 4, DataTypes.BIGINT, true, false),
    Column("t_second", 5, DataTypes.BIGINT, true, false),
...
object Warehouse extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    Column("w_warehouse_sk", 0, DataTypes.BIGINT, false, true),
    Column("w_warehouse_id", 1, DataTypes.STRING, false, false),
    Column("w_warehouse_name", 2, DataTypes.STRING, true, false),
    Column("w_warehouse_sq_ft", 3, DataTypes.BIGINT, true, false),
    ...
    Column("w_gmt_offset", 13, DataTypes.DECIMAL(5, 2), true, false)
  )
...
object WebPage extends TpcDsSchema {
  ...
  override val columns = Array[Column](
    ...
    Column("wp_customer_sk", 7, DataTypes.BIGINT, true, false),
    Column("wp_url", 8, DataTypes.STRING, true, false),
    Column("wp_type", 9, DataTypes.STRING, true, false),
    Column("wp_char_count", 10, DataTypes.BIGINT, true, false),
    Column("wp_link_count", 11, DataTypes.BIGINT, true, false),
    Column("wp_image_count", 12, DataTypes.BIGINT, true, false),
    Column("wp_max_ad_count", 13, DataTypes.BIGINT, true, false)
  )
...
object WebSite extends TpcDsSchema {
  override val columns = Array[Column](
    ...
    Column("web_mkt_id", 9, DataTypes.BIGINT, true, false),
    ...
    Column("web_company_id", 13, DataTypes.BIGINT, true, false),
    ...
    Column("web_gmt_offset", 24, DataTypes.DECIMAL(5, 2), true, false),
    Column("web_tax_percentage", 25, DataTypes.DECIMAL(5, 2), true, false)
  )
